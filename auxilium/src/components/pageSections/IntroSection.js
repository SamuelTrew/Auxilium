...
const IntroSection = () => {
    return (
        <>
            <div className="container" style={{marginBottom: '8%', marginTop: '8%'}}>
                <h1 className="section-heading">Building an inclusive web.</h1>
                <div className="container__row section-container">
                    ...
                    <h2 className="is-black-text highlight" style={{margin: '10px', marginLeft: '0'}}>        
                        ...
                        The internet can be a hostile space for the 15% of the world's population who experience some form of disability.
                        </p>
                        <p className="is-black-text">
