            ...
            <div className="container" style={{marginBottom: '5%', marginTop: '5%'}}>
                ...
                <div className="container__row section-container">
                    <div className="container__col-sm-12">
                        <h4 className="is-very-dark-grey-text" style={{margin: '10px', marginLeft: '0'}}>
                            Never Depend on Color Alone to Convey CriInformation
                        </h4>
                        ...
                        <a id="dyslexia-link"className="button" href="/comparison" style={{cursor: "pointer"}}>
                            <span>Click me</span>
                        </a>
                    </div>
                </div>
